...
export async function getArticleBySlug(slug) {
  return client.fetch(`
    *[_type == "article" && slug.current == $slug][0] {
      _id, title, slug, category, excerpt, body, coverImage, author, publishedAt, readTime, youtubeUrl, instagramUrl, instagramReelUrl
    }
  `, { slug })
}
...
export async function getUpcomingReleases(limit = 8) {
  return client.fetch(`
    *[_type == "release"] | order(releaseDate dasc) [0...$limit] {
